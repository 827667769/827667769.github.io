var canvas = document.querySelector("#canvas_words"),
	ctx = canvas.getContext("2d"),
	link = document.createElement('link');
particles = [], amount = 0, mouse = {
	x: -9999,
	y: -9999
}, radius = 1, colors = ["rgba(0,222,255,0.85)", "rgba(12,253,74,0.75)", "rgba(193,253,12,0.85)", "rgba(192,213,255,0.85)", "rgba(244,223,254,0.75)"], headline = document.querySelector("#headline"), ww = window.innerWidth, wh = window.innerHeight;
